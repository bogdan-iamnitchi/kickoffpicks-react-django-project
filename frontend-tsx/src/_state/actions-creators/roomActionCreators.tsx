...
export const statusRoom = () => async (dispatch: Dispatch<RoomAction>) => {
    ...
    try {
        const res = await axios.post(
            `${import.meta.env.VITE_APP_API_URL}/rooms-api/status-room/`,
            body,
            config
        );
